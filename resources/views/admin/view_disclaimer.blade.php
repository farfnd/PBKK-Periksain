...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Periksa.in Admin - Lihat Sanggahan</title>
                    ...
                    <div class="page-info container">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Lihat Sanggahan</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-title">
                                <h5 class="card-title" style="text-align:center; "><b>Detail Sanggahan</b></h5>
                            </div>
                        </div>
                    </div>
                    <div class="main-wrapper container">
                        <div class="row">
                            <div class="col-xl">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">Informasi Sanggahan</h5>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                    {{ $sanggahan->nama_terlapor }} (<a href="/admin/laporan/lihat/{{ $sanggahan->id_laporan }}">Lihat Laporan</a>)
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Disanggah Oleh</th>
                                                    <td>
                                                    {{ $sanggahan->first_name." ".$sanggahan->last_name }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Detail Sanggahan</th>
                                                    <td>
                                                    {{ $sanggahan->sanggahan }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Foto Pendukung</th>
                                                    <td>
                                                    Belum Tersedia
                                                    </td>
                                                </tr>
                                        ...
                                        <form method="POST" id="form_respon" action="{{route('admin.respon_disclaimer')}}" enctype="multipart/form-data">
                                            @csrf
                                            <input type="text" class="form-control" name="tipe_laporan" value="rekening" hidden>
                                            <input type="text" class="form-control" name="id" value="{{ $sanggahan->id }}" hidden>
