                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{route('report.update', ['id' => $report->id])}}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nama_terlapor" placeholder="Nama Pemilik Rekening" name="nama_terlapor" value="{{ $report->nama_terlapor }}">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <select class="form-control custom-select" id="bank" name="bank">
                                                        ...
                                                        @foreach ($data_bank as $bank)
                                                            <option value="{{ $bank->nama_bank }}" {{ (($report->bank == $bank->nama_bank) || old('bank') == $bank->nama_bank) ? "selected" : "" }}>{{ $bank->nama_bank }}</option>
                                                        @endforeach
                                                    </select>
                                                    @if ($errors->has('bank'))
                                                ...
                                                <div class="form-group col-md-6">
                                                    <input type="text" class="form-control" id="nomor_rekening" placeholder="Nomor Rekening" name="nomor_rekening" value="{{ $report->nomor_rekening }}">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <select class="form-control custom-select" id="platform" name="platform">>
                                                        <option disabled hidden>Pilih Platform...</option>
                                                        <option value="WhatsApp" {{ (($report->platform == "WhatsApp") || old('platform') == "WhatsApp") ? "selected" : "" }}>WhatsApp</option>
                                                        <option value="LINE" {{ (($report->platform == "LINE") || old('platform') == "LINE") ? "selected" : "" }}>Line</option>
                                                        <option value="Facebook" {{ (($report->platform == "Facebook") || old('platform') == "Facebook") ? "selected" : "" }}>Facebook</option>
                                                        <option value="Instagram" {{ (($report->platform == "Instagram") || old('platform') == "Instagram") ? "selected" : "" }}>Instagram</option>
                                                        <option value="Twitter" {{ (($report->platform == "Twitter") || old('platform') == "Twitter") ? "selected" : "" }}>Twitter</option>
                                                        <option value="Lainnya" {{ (($report->platform == "Lainnya") || old('platform') == "Lainnya") ? "selected" : "" }}>Lainnya</option>
                                                    </select>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <input type="text" class="form-control" id="kontak_pelaku" placeholder="Kontak" name="kontak_pelaku" value="{{ $report->kontak_pelaku }}">
